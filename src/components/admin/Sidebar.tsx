...
export function Sidebar({
  ...
  return (
    <aside className="w-[256px] shrink-0 h-[100dvh] sticky top-0 border-r border-border/60 bg-background/90 backdrop-blur-3xl transition-all duration-300 z-20 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.08)] dark:shadow-[4px_0_24px_-12px_rgba(0,0,0,0.6)] flex flex-col hidden lg:flex">
      {/* Logo */}
